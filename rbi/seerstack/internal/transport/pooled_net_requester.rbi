      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                Seerstack::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: Seerstack::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: Seerstack::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
