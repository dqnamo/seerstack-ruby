    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Seerstack::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Seerstack::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
            ...
            params(
              ...
              type_info:
                T.any(
                  ...
                  T.proc.returns(Seerstack::Internal::Type::Converter::Input),
                  Seerstack::Internal::Type::Converter::Input
                ),
              spec: Seerstack::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: Seerstack::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: Seerstack::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: Seerstack::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Seerstack::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Seerstack::Internal::AnyHash) }
        def to_h
        end
