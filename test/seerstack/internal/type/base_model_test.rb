...
class Seerstack::Test::PrimitiveModelTest < Minitest::Test
  A = Seerstack::Internal::Type::ArrayOf[-> { Integer }]
  H = Seerstack::Internal::Type::HashOf[-> { Integer }, nil?: true]

  module E
    extend Seerstack::Internal::Type::Enum
  end

  module U
    extend Seerstack::Internal::Type::Union
  end

  class B < Seerstack::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Seerstack::Internal::Type::Unknown,
      Seerstack::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Seerstack::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Seerstack::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Seerstack::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Seerstack::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Seerstack::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Seerstack::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Seerstack::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Seerstack::Internal::Type::Boolean, true] => true,
      [Seerstack::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Seerstack::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Seerstack::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Seerstack::Internal::Type::Converter.new_coerce_state
      Seerstack::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Seerstack::Internal::Type::Converter.dump(target, input, state: state)
...
class Seerstack::Test::EnumModelTest < Minitest::Test
  class E0
    include Seerstack::Internal::Type::Enum
...
class Seerstack::Test::CollectionModelTest < Minitest::Test
  A1 = Seerstack::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Seerstack::Internal::Type::HashOf[Integer]

  A2 = Seerstack::Internal::Type::ArrayOf[H1]
  H2 = Seerstack::Internal::Type::HashOf[-> { A1 }]

  A3 = Seerstack::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Seerstack::Internal::Type::HashOf[Integer, nil?: true]
...
class Seerstack::Test::BaseModelTest < Minitest::Test
  class M1 < Seerstack::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Seerstack::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Seerstack::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Seerstack::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Seerstack::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Seerstack::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Seerstack::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Seerstack::Errors::ConversionError => e
...
class Seerstack::Test::UnionTest < Minitest::Test
  class U0
    include Seerstack::Internal::Type::Union
  ...
  class M2 < Seerstack::Internal::Type::BaseModel
  ...
  class M4 < Seerstack::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Seerstack::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Seerstack::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Seerstack::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Seerstack::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Seerstack::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Seerstack::Internal::Type::Unknown, Seerstack::Internal::Type::Unknown] => true,
      [Seerstack::Internal::Type::Boolean, Seerstack::Internal::Type::Boolean] => true,
      [Seerstack::Internal::Type::Unknown, Seerstack::Internal::Type::Boolean] => false,
...
class Seerstack::Test::MetaInfoTest < Minitest::Test
  A1 = Seerstack::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Seerstack::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
