...
module Seerstack
  module Internal
    module Type
      ...
      # `Seerstack::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Seerstack::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Seerstack::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Seerstack::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Seerstack::FilePart.new(value, filename: "upload") : value
            in Seerstack::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
