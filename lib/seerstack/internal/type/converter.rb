    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Seerstack::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Seerstack::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Seerstack::FilePart.new(value)
          in Seerstack::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Seerstack::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Seerstack::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Seerstack::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Seerstack::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Seerstack::Internal::Type::Converter
              ...
              Seerstack::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Seerstack::Internal::Type::Converter, T::Class[T.anything]) }
        end
