...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/seerstack/helpers/` and `examples/` directory.
...
require_relative "../lib/seerstack"
...
```ruby
gem "seerstack", git: "https://www.github.com/stainless-sdks/seerstack-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/seerstack-ruby' '<path-to-repo>'
```

```ruby
gem "seerstack", path: "<path-to-repo>"
```
